...
def draw_stars(canvas, height, width):
    ...
    This function generates a specified number of stars at random positions on the canvas. Each star is created using the 'blink' function, which animates the stars to make them twinkle. The positions and symbols of the stars are generated by the 'create_stars' function.

    :param canvas: The curses canvas on which the stars will be displayed.
    :param height: The height of the canvas, used to determine the range of possible star positions.
    :param width: The width of the canvas, used to determine the range of possible star positions.
    """
    stars = [
...
def draw_window(canvas, height):
    ...
    This function creates a sub-window (status window) at the bottom of the main canvas. The status window is used to display text or information related to the game's status. It defines the size and position of the status window and initializes it with a border and text.

    :param canvas: The main curses canvas where the status window will be displayed.
    :param height: The height of the main canvas, used to determine the position of the status window.
    """
